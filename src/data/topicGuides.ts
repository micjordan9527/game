...
export const topicGuides: TopicGuide[] = [
  ...
  },
  {
    ...
    outcomes: ["理解复杂业务页面为什么要强调信息层级", "能从后台、表格、状态和流程角度审视体验", "能用清单和场景完成一次可执行的体验评审"],
    readingOrder: ["admin-information-hierarchy", "admin-modules", "bet-ticket-status", "wallet-center-vs-seamless", "launch-checklist"],
    ...
    modules: [
      {
        ...
        articles: ["admin-information-hierarchy", "admin-modules", "bet-ticket-status"],
      },
      {
        id: "design-module-2",
        title: "模块 2：移动端与状态反馈",
        description: "把选玩法、填写金额、确认提交和结果反馈组织成清楚的操作路径。",
        learningObjectives: ["定义用户在关键动作中的确认与回退点", "让成功、处理中和失败状态说清原因与下一步", "避免关键字段遗漏造成的误操作"],
        estimatedMinutes: 18,
        difficulty: "进阶",
        audienceHints: ["设计师", "前端", "产品"],
        durationReason: "结合移动端投注路径与状态反馈，适合在交互设计前完成一次专项走查。",
        articles: ["wallet-center-vs-seamless", "launch-checklist"],
      },
      {
        id: "design-module-3",
        title: "模块 3：体验评审与交付协作",
        description: "用统一的检查项和完成标准，连接业务规则、页面实现与验收结果。",
        learningObjectives: ["按风险和任务调整后台列表的默认信息", "用体验清单识别高优先级问题", "明确产品、设计、前端与验收之间的交付边界"],
        estimatedMinutes: 15,
        difficulty: "进阶",
        audienceHints: ["设计师", "产品经理", "前端", "测试"],
        durationReason: "聚焦评审与协作中的共同语言，适合页面进入开发前或验收前快速对齐。",
        articles: ["admin-modules", "launch-checklist"],
      },
    ],
  },
  {
